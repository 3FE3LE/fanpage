    ...
    <div className='w-full bg-gray-200 min-h-screen flex flex-col md:flex-row lg:w-10/12 justify-center items-center'>
      <div className="w-full md:w-10/12 bg-gray-300 min-h-screen flex grid grid-rows-5">
        <div className="w-full h-full row-span-3 flex">
          <div className="w-0 sm:w-2/12 border bg-gray-400 h-full"></div>
        ...
        <div className="w-full h-full row-span-2 flex">
          <div className="w-2/12 sm:w-4/12 bg-gray-400 border min-h-full"></div>
          <div className="w-8/12 sm:w-6/12 bg-gray-400 border min-h-full">
          ...
          <div className="w-2/12 bg-gray-400 border min-h-full p-2"></div>
        </div>
      </div>
      <div className="w-full  md:w-2/12 bg-gray-400 min-h-screen grid grid-rows-5 ">
        <div className="w-full bg-gray-400 border row-span-4 md:row-span-2"></div>
        <div className="w-full bg-gray-400 border row-span-1 md:row-span-3"></div>
      </div>
    </div>
  </>
)
