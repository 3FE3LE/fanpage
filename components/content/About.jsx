...
const About = () => {
  ...
  return (
    <>
      <div onClick={() => handleClick()} className="w-full bg-white row-span-2 md:row-span-2 shadow-inner sm:transition duration-500 ease-in-out transform sm:hover:-translate-x-2 cursor-pointer sm:hover:translate-y-1 sm:hover:scale-105">
