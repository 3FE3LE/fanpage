...
const Youtuber = () => {
  ...
  return (
    <>
      <div onClick={() => handleClick()} className="w-2/12  bg-gradient-to-tr from-red-500 via-red-700 to-red-600 min-h-full p-2 shadow-inner flex items-center justify-center sm:transition duration-500 ease-in-out transform  cursor-pointer sm:hover:-translate-y-3 sm:hover:scale-105">
