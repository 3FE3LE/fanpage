...
const Developer = () => {
  ...
  return (
    <>
      <div onClick={() => handleClick()} className="w-2/12 md:w-4/12 bg-circuit bg-gray-200 min-h-full p-2 shadow-inner flex items-center justify-center  sm:transition duration-500 ease-in-out transform  cursor-pointer sm:hover:-translate-y-3 sm:hover:scale-105">
      ...
      <Fade in={show} timeout={{ appear: 30000, enter: 1000, exit: 800 }}>
        <div className="fixed top-0 z-100 right-0 left-0 bottom-0 bg-circuit bg-gray-200 w-screen h-screen pb-12 px-4 font-black text-2xl">
          <div className="w-full h-full relative" >
            <svg onClick={() => handleClose()} className="w-12 h-12 text-teal-500 fixed top-1/12 right-1/12 cursor-pointer" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
