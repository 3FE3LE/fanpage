    ...
    <>
      <div className="flex justify-between w-full h-0 -mt-6 -ml-6">
        <Link href="https://github.com/3FE3LE">
          ...
          <div className=" h-12 w-12 bg-white shadow-md rounded-full flex items-center justify-center">
        ...
        <Link href="https://www.instagram.com/3fe3le/">
          <a className={linkClass} >
          <div className=" h-12 w-12 bg-yellow-300 border-4 border-white shadow-md rounded-full flex items-center justify-center">
