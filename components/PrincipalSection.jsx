  ...
  return (
    <>
      <section className='w-full h-screen min-h-full flex flex-wrap justify-center items-center'>
        <div className="w-full h-full md:w-10/12 grid grid-rows-5 ">
          <div className="w-full h-full row-span-3 flex flex-wrap">
            ...
            <div className="w-full sm:w-6/12 md:w-5/12 h-auto grid grid-rows-2 sm:grid-rows-3">
              <div className="w-full sm:h-full row-span-1 sm:row-span-2 bg-black px-2 py-2 sm:p-4 flex flex-wrap items-center justify-between text-white shadow-2xl ">
                <h1 className="text-2xl sm:text-4xl px-2 "> Bienvenido a...</h1>
            ...
            <div className="w-full sm:w-6/12 md:w-5/12 h-auto text-2xl xl:text-3xl bg-gray-100 p-4 shadow-inner">
